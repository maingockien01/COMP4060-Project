...
export { InteroraclePacketData, NoData, RequestIndexPacketData, RequestIndexPacketAck, Params };
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: maingockien01.simple_oracle.interoracle initialized!')
